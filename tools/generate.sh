...
function presentational {
	...
	mkdir -p $DIR
	sed -e "s;%NAME%;${NAME};g" templates/component.jsx > "${DIR}/${NAME}.jsx"
	sed -e "s;%NAME%;${NAME};g" templates/component-style.css > "${DIR}/${NAME}.css"
}
...
function container {
	...
	DIR="../src/components/${NAME}"
	mkdir -p $DIR
	sed -e "s;%NAME%;${NAME};g" templates/component-redux.jsx > "${DIR}/${NAME}.jsx"
	sed -e "s;%NAME%;${NAME};g" templates/component-style.css > "${DIR}/${NAME}.css"
}
